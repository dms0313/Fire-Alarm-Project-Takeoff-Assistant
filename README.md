...
- Vercel installs from `requirements-vercel.txt` to keep the serverless bundle small; optional heavy packages (e.g., PyTorch/Ultralytics) are omitted but handled gracefully by the app.
